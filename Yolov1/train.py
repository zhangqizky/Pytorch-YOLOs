...
test_dataset = yoloDataset(root=file_root,list_file='voc2012_test.txt',train=False,transform = [transforms.ToTensor()] )
...
for epoch in range(num_epochs):
    ...
    logfile.flush()      
    torch.save(net.state_dict(),'epoch_%02d_valloss_%0.4f_yolo.pth'%(epoch,validation_loss))
